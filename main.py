...
async def serve_ui():
    ...
    <body>
        <div class="chat-container">
            ...
            <div class="header" style="background-color: #005c4b !important; border-bottom: 1px solid rgba(255,255,255,0.08); display: flex; align-items: center; padding: 10px 16px;">
